...
public class SmartBoard_Paint {
    ...
    static SmartBoard_Paint m_UiRef;
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (result==JFileChooser.APPROVE_OPTION ) {
                        try {
                            ...
                            ImageIO.write(SmartBoard_Paint.this.canvasImage, "png", f);
                            SmartBoard_Paint.this.originalImage = SmartBoard_Paint.this.canvasImage;
                            dirty = false;
    ...
    public static SmartBoard_Paint getInstance () {
        return m_UiRef;
    }
    ...
    public static void start () {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                m_UiRef = new SmartBoard_Paint ();

                JFrame f = new JFrame("DooDoodle!");
                f.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                f.setLocationByPlatform(true);

                f.setContentPane(m_UiRef.getGui());
                f.setJMenuBar(m_UiRef.getMenuBar(false));
    ...
    class ImageMouseListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent arg0) {
            // TODO Auto-generated method stub
            if (activeTool==SmartBoard_Paint.SELECTION_TOOL) {
                selectionStart = arg0.getPoint();
            } else if (activeTool==SmartBoard_Paint.DRAW_TOOL) {
                // TODO
                draw(arg0.getPoint());
            } else if (activeTool==SmartBoard_Paint.TEXT_TOOL) {
                // TODO
                text(arg0.getPoint());
            } else {
                JOptionPane.showMessageDialog(
